...
public class CarMaintain {
    ...
    public CarMaintain(String carName, int odometerCurrent, int odometerNextOilChange,
                       String airFilterStatus, String cabinFilterStatus, String oilFilterStatus)
    {
