...
// All Cities starting with A
                System.out.println();
                System.out.println("All Cities starting with A");
                printCitiesA(myCities);
        System.out.println();
        System.out.println("All Cities Reversed");
        printCitiesReversed(myCities);

                System.out.println();
                System.out.println("All Cities starting with AH");
                printCitiesAH(myCities);
  ...
  public static void printCitiesReversed(String[][] cities){
    ...
    public static void printCitiesAH(String[][] cities) {
        for (String[] row : cities) {
            for (String city : row) {
                for(int i=65; i<=72; i++)
                if (city.charAt(0) == i) {
